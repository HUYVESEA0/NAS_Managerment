...
### With COPILOT.md Rules

- **Priority**: COPILOT.md rules > intelligent-routing
- If COPILOT.md specifies explicit routing, follow it
...
**Next Steps**: Integrate this skill into COPILOT.md TIER 0 rules.
