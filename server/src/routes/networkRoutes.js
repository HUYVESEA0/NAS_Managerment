...
// Tìm kiếm files
router.get('/search', authorize('READ_FILES', 'BROWSE_FILES'), authorizeMachineScope(), networkController.searchFiles);
...
// Preview file
router.get('/preview', authorize('READ_FILES', 'BROWSE_FILES'), authorizeMachineScope(), networkController.previewFile);
