...
const Login = () => {
    ...
    useEffect(() => {
        const messages = [
            ...
            'ESTABLISHING ENCRYPTION PROTOCOLS...',
        ...
        <div className="min-h-screen bg-base flex flex-col justify-center items-center relative overflow-hidden font-sans">
            ...
            <div className="w-full max-w-md p-6 relative z-10">
                ...
                <div className="mb-8 text-center flex flex-col items-center">
                    ...
                    <p className="text-secondary text-sm mt-2 font-mono">SECURE ACCESS PORTAL</p>
                </div>
                ...
                <div className="bg-surface border border-border-default rounded-xl shadow-lg overflow-hidden backdrop-blur-sm">
                    ...
                    <div className="px-6 py-4 border-b border-border-subtle bg-base/50 flex items-center gap-3">
                        ...
                        <h2 className="font-mono font-bold text-primary tracking-wide text-sm">AUTHENTICATION REQUIRED</h2>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-5">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-1">
                                <label className="text-xs font-bold font-mono text-secondary ml-1 block">USERNAME</label>
                            ...
                            {/* Password Input */}
                            <div className="space-y-1">
                                <label className="text-xs font-bold font-mono text-secondary ml-1 block">PASSWORD</label>
                                <div className="relative group">
                                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-muted group-focus-within:text-accent transition-colors">
                                        <Lock size={16} />
                                    </div>
...
`
fs.writeFileSync('src/pages/Login.jsx', fileContent);
console.log('Updated Login page to red accent style');
